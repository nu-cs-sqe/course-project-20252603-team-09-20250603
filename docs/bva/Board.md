...
|              | State of the System                                                    | Expected output / behavior                      | Implemented?  |
|--------------|------------------------------------------------------------------------|-------------------------------------------------|---------------|
| Test Case 1  | Dice roll is 2 (minimum valid value) and matching hex has a settlement | Settlement owner receives 1 resource            | :x:           |
...
| Test Case 10 | Dice roll matches a multiple hexes with multiple occumied nodes each   | All eligible players receive resources          | :x:           |
