...
|-------------|---------------------------------------------|------------------------------------------------------------------|--------------|
| Test Case 1 | Roll is not 7                               | Robber does not move                                             | :x: |
| Test Case 2 | Roll is 7 and no hex currently has robber   | Selected hex has robber                                          | :x: |
| Test Case 3 | Roll is 7 and robber starts on another hex  | Previous hex no longer has robber; selected hex has robber       | :x: |
| Test Case 4 | Roll is 7 and selected hex already has robber | Robber remains on selected hex                                 | :x: |
| Test Case 5 | Roll is 7 and robber moves                  | Exactly one hex has robber                                       | :x: |
| Test Case 6 | Roll is 7 and selected hex ID is invalid    | Throws `IllegalArgumentException`                                | :x: |
