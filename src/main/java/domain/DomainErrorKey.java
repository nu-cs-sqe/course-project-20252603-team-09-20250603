...
public enum DomainErrorKey {
    ...
    PLACEMENT_CITY_ON_OPPONENT_NODE("error.placement.cityOnOpponentNode"),
    PLACEMENT_CITY_ALREADY_UPGRADED("error.placement.cityAlreadyUpgraded"),
    PLACEMENT_CITY_REQUIRES_SETTLEMENT("error.placement.cityRequiresSettlement"),
